...
public class Expenditure extends AccountTransaction {
    public Expenditure(String subject, double value, String description, Category category, boolean isRecurring, Month month, int year) {
